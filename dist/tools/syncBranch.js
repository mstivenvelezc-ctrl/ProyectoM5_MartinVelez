...
export function registerSyncBranchTool(server) {
    server.registerTool("sync_branch", {
        title: "Sincronizar rama con principal",
        description: "Trae los últimos cambios de la rama principal (por defecto 'main') " +
            "y los fusiona dentro de la rama indicada, manteniéndola actualizada.",
        inputSchema: {
            owner: ownerSchema,
            repo: repoNameSchema,
            branch: requiredBranchSchema.describe("Rama que se quiere actualizar con los cambios de la principal (ej. 'feature/mi-cambio')."),
        ...
        try {
            ...
            if (data === null) {
                return ok(`La rama '${branch}' ya está al día con '${base}'. No hay cambios nuevos.`);
            }
            return ok(`Rama '${branch}' actualizada con los cambios de '${base}'.\n` +
...
//# sourceMappingURL=syncBranch.js.map