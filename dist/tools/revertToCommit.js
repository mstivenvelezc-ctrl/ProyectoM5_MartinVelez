...
import { branchSchema, commitShaSchema, confirmSchema, ownerSchema, repoNameSchema, } from "../schemas/github.js";
export function registerRevertToCommitTool(server) {
    server.registerTool("revert_to_commit", {
        title: "Regresar a un commit anterior",
        description: "Mueve una rama a un commit anterior (hard reset). Descarta los commits " +
        ...
        try {
            ...
            if (!confirm) {
                return needsConfirmation(`Se moverá la rama "${targetBranch}" de ${owner}/${repo} al commit ${sha}.\n` +
            ...
            return ok(`Rama "${targetBranch}" de ${owner}/${repo} movida al commit ${data.object.sha}.`);
        }
        catch (error) {
...
//# sourceMappingURL=revertToCommit.js.map