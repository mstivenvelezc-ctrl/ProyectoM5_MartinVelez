...
export const repoNameSchema = z
    ...
    .regex(/^[a-zA-Z0-9._-]+$/, "Nombre inválido: solo se permiten letras, números, guiones, puntos y underscores (sin espacios ni símbolos).");
...
export const requiredBranchSchema = z
    ...
    .regex(/^[^\s~^:?*\[\\]+(?<!\.lock)$/, "Nombre de rama inválido según las reglas de Git.");
...
export const commitShaSchema = z
    .string()
    .trim()
    .regex(/^[0-9a-f]{7,40}$/i, "SHA inválido: debe ser hexadecimal de 7 a 40 caracteres.");
// Confirmación humana para acciones destructivas.
export const confirmSchema = z
    .boolean()
    .optional()
    .default(false)
    .describe("Debe ser true para ejecutar la acción destructiva. Si es false, la tool solo muestra una alerta sin ejecutar.");
...
export const confirmNameSchema = z
    ...
    .trim()
    .optional()
    .describe('Para confirmar el borrado, escribe el nombre completo "owner/repo" exactamente igual.');
